...
function App() {
  return (
    <IxApplication>
      <IxApplicationHeader name="Sarah's Assignment">
            ...
            <svg xmlns="http://www.w3.org/2000/svg" width="136.221" height="12" viewBox="0 0 136.221 12">
                <g id="Gruppe_4763" data-name="Gruppe 4763" transform="translate(-85 -28)">
                    <g id="Polygon_3" data-name="Polygon 3" transform="translate(111 28)" fill="none">
                        <path d="M7,0l7,12H0Z" stroke="none"></path>
                        <path d="M 7 3.969271659851074 L 3.482074737548828 10 L 10.51792526245117 10 L 7 3.969271659851074 M 7 9.5367431640625e-07 L 14 12 L 0 12 L 7 9.5367431640625e-07 Z" stroke="none" fill="var(--theme-app-header-logo--color)"></path>
                    </g>
