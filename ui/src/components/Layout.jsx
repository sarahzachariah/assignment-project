                ...
                <div className="placeholder-logo" slot="logo">
                    <svg xmlns="http://www.w3.org/2000/svg" width="136.221" height="12" viewBox="0 0 136.221 12">
                        <g id="Gruppe_4763" data-name="Gruppe 4763" transform="translate(-85 -28)">
                            ...
                            <g id="Ellipse_14" data-name="Ellipse 14" transform="translate(99 28)" fill="none" stroke="var(--theme-app-header-logo--color)" strokeWidth="2">
                                <circle cx="6" cy="6" r="6" stroke="none"></circle>
                                <circle cx="6" cy="6" r="5" fill="none"></circle>
                            </g>
                            <g id="Rechteck_1111" data-name="Rechteck 1111" transform="translate(85 28)" fill="none" stroke="var(--theme-app-header-logo--color)" strokeWidth="2">
